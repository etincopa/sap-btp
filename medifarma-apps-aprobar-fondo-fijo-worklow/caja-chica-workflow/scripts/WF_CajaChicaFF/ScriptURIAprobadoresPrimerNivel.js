...
uri = uri + "(Bukrs='" + param_.Bukrs + "',Prcid='" + param_.Prcid + "',Rulid='" + param_.Rulid + "',Tskid='" + param_.Iskid +
...
// uri = "/sap/opu/odata/eper/OD_MM_UTILIDADES_SRV/zinaprobadoresSet(Bukrs='1000',Prcid='P010',Rulid='',Tskid='G001',Tabname='CSKS',Fieldname='KOSTL',Value='10001A6011',Isfound=false,TabSearch='PA0001',FieldSearch='PLANS')/zaprobadoresmultout?$format=json"
