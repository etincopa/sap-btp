...
sap.ui.define(
  ...
  function (
    ...
    return Control.extend(
      "com.medifarma.cp.pesajeimpresionbultosaldo.controls.ExtScanner",
      {
        metadata: {
          manifest: "json",
          properties: {
        ...
        onDecoderChanges: function (oEvent) {
          ...
          if (this.lastScannedResult) {
            var sResultText =
              oDecoder.decoder(this.lastScannedResult) ||
              this.lastScannedResult.text;
        ...
        getSettingsPopover: function () {
          if (!this.oSettingsPopover) {
            this.oSettingsPopover = sap.ui.xmlfragment(
              this.getId(),
              "com.medifarma.cp.pesajeimpresionbultosaldo.controls.fragments.settingsPopover",
              this
            );
        ...
        openChangePopover: function (oSource) {
          ...
          if (oList) {
            ...
            if (sSelectedId) {
              var oSelectedItem = this._oScanModel
                .getProperty("/videoDevices")
                .find(function (item) {
        ...
        getCurrentVideoDevice: function () {
          ...
          if (!sId) {
            if (this._oDecoder && this._oDecoder.stream) {
              ...
              if (oTrack) {
                var oCap = oTrack.getCapabilities
                  ? oTrack.getCapabilities()
                  : oTrack.getSettings();
                if (oCap) {
                  sId = oCap.deviceId;
                }
        ...
        _getScanDialog: function () {
          if (!this._oTD) {
            this._oTD = sap.ui.xmlfragment(
              this.getId(),
              "com.medifarma.cp.pesajeimpresionbultosaldo.controls.fragments.scanDialog",
              this
            );
        ...
        _getInputDialog: function () {
          if (!this._oID) {
            this._oID = sap.ui.xmlfragment(
              this.getId(),
              "com.medifarma.cp.pesajeimpresionbultosaldo.controls.fragments.inputDialog",
              this
            );
        ...
        getDecoderByKey: function (sKey) {
          var oDecoder = this._oScanModel
            .getProperty("/decoders")
            .find(function (item) {
        ...
        _saveScannedValue: function (result, error) {
          if (result) {
            ...
            var oDecoder = this.getDecoderByKey(
              this._oScanModel.getProperty("/decoderKey")
            );
        ...
        _getDialogHeader: function () {
          if (!this._oHeader) {
            this._oHeader = sap.ui.xmlfragment(
              this.getId(),
              "com.medifarma.cp.pesajeimpresionbultosaldo.controls.fragments.toolbar",
              this
            );
