...
sap.zen.Dispatcher = function() {
	...
	this.updateComponentPropertiesBase = function(oControl, oComponentProperties) {
		...
		var oldWidth = oControl.$().width();
		var oldHeight = oControl.$().height();
		
		this.setWidthHeight(oControl, width, height);
		var newArgs = this.setAbsoluteLayoutInfo(oControl, args);
		this.registerControlForResizeNotificationIfNecessary(oControl,args,newArgs, oldWidth, width, oldHeight, height);
