...
if (lDebug) {
	document.write('<p><a href="javascript:sapbi_reloadTemplate()">reload</a></p>');
	document.write('<p><a href="javascript:debugger;">debug</a></p>');
	document.write('<textarea id="zen_xml" cols="80" rows="5"></textarea>');
	document.write('<p><a href="javascript:sapbi_execXml()">execute XML</a></p>');
	document.write('<p><a href="javascript:sapbi_page.showProfile()">display profile</a></p>');
	document.write('<p><a href="javascript:alert(document.documentMode)">display mode</a></p>');
}
...
function sapbi_phx(divid, json) {
	...
	if (parent) {
		url = parent.window.location.search.indexOf(searchString);
	}
	...
	if (lDebug) {
		...
		document.getElementById("zen_xml").value = jsonAsString;
	}
