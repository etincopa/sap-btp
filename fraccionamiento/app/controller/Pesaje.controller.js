    ...
    return Controller.extend("mif.cp.fraccionamiento.controller.Pesaje", {
      ...
      onRefrescarDatos: async function () {
        ...
        try {
          ...
          var sUnidad = this._getProperty("/Pesaje_Fraccionamiento/unidadMostrar");
      ...
      onGuardarPesaje: async function (oEvent) {
        ...
        try {
           ...
           */
          var aBultoConsumida = this._getBultoConsumido(aBultoQr, iPesoBalanza);
      ...
      onBalanzaChange: async function (oEvent) {
        ...
        if (oBalanza.balanzaId == "0") {
          ...
          if (oTipoBalanzaReq.balanza == "ANALITICA") {
            ...
            this._setProperty("/Pesaje_Pendiente2", formatter.peso(fPendiente));
      ...
      onTaraManualPress: async function () {
        ...
        if (oOpciones.TaraManual) {
          this.openDialog("TaraManual", { source: "Pesaje", esBalanzaPiso: bBalanzaPiso });
        } else {
          MessageBox.msgAlerta(
