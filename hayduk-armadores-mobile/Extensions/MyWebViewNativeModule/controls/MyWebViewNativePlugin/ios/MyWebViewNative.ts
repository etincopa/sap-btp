...
/*
  ...
  You will encapsulate the MyWebViewNative class definition inside a function called GetMyWebViewNativeClass
...
export function GetMyWebViewNativeClass() {
    ...
    class SliderHandler extends NSObject {
        ...
        public valueChanged(nativeSlider: UISlider, nativeEvent: _UIEvent) {
            ...
            const owner: MyWebViewNative = (<any>nativeSlider).owner;
            if (owner) {
