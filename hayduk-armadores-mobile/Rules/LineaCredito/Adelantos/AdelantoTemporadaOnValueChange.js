 ...
 */
export default function AdelantoTemporadaOnValueChange(clientAPI) {
    ...
    try {
        ...
        //lpEspecie = clientAPI.evaluateTargetPath("#Page:AdelantoEspecieTemporadaFilter/#Control:lpEspecie").getValue()[0].ReturnValue;

        clientAPI.evaluateTargetPath("#Page:Adelantos/#Control:spTemporada").setValue(lpTemporada);
    ...
    if (isOk) {
        ...
        appSettings.setString("TemporadaAdelanto", lpTemporada);
        let qo = `$filter=IDEspecie eq '01' and IDTipo eq 'ADELTEMP' and IDTemporada eq '${lpTemporada}'`;
