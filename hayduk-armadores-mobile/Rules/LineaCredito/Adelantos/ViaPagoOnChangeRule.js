...
export default function ViaPagoOnChangeRule(clientAPI) {
    ...
    var plantaCtrl = {};
    try {
        plantaCtrl = clientAPI.evaluateTargetPath("#Page:SolicitarAdelanto/#Control:lpPlanta");

    } catch (ex) {
        plantaCtrl = clientAPI.evaluateTargetPath("#Page:SolicitudPendAdelantoDetail/#Control:lpPlanta");
    }
