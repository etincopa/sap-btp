 ...
 */
export default function AdelantoEspecieOnValueChange(clientAPI) {
    ...
    clientAPI.evaluateTargetPath("#Page:Adelantos/#Control:spEspecie").setValue(sDisplayValue);
    clientAPI.evaluateTargetPath("#Page:Adelantos/#Control:spTemporada").setValue("");
