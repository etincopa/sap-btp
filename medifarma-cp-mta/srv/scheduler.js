...
module.exports.runJob = async function () {
  ...
  var job = new CronJob(
    ...
    async function () {
      /**
       * SCHEDULE (Se ejecuta segun configuracion CRON)
       * - Desactivar tara manual (SALA_PESAJE)
       * - Desactivar peso manual (SALA_PESAJE)
       * - Desactivar lectura etiqueta (SALA_PESAJE)
       *
       * Realiza lo siguiente:
       * - 1.- Obtiene los registros de  estados de la tabla MAESTRA
       * - 2.- Obtiene todos los registros de la TARA MANUAL cuyo estado sea HABILITADO
       *     - Si:
       *       La fecha y hora de inicio de la Tara Manual + la Hora asignado para deshabilitarse
       *       es < a la fecha y hora actual se DESHABILITA la Tara Manual para la SALA_PESAJE
       *
       * - 3.- Obtiene todos los registros de la PESO MANUAL cuyo estado sea HABILITADO
       *     - Si:
       *       La fecha y hora de inicio del Peso Manual + el Minuto asignado para deshabilitarse
       *       es < a la fecha y hora actual se DESHABILITA el Peso Manual para la SALA_PESAJE
       *
       * - 4.- Obtiene todos los registros de la LECTURA ETIQUETA cuyo estado sea HABILITADO
       *     - Si:
       *       La fecha y hora de inicio de la Lectura Etiqueta + la Hora asignado para deshabilitarse
       *       es < a la fecha y hora actual se DESHABILITA la Lectura Etiqueta para la SALA_PESAJE
       */
