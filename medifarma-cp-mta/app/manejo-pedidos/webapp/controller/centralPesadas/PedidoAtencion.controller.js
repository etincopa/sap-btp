sap.ui.define(
  ...
  function (
    ...
    return BaseController.extend(
      "com.medifarma.cp.manejopedidos.controller.centralPesadas.PedidoAtencion",
      {
        formatter: formatter,
        ...
        onInit: function () {
          ...
          that.oRouter
            .getTarget("TargetPedidoAtencion")
        ...
        _handleRouteMatched: function (oEvent) {
          ...
          var oTable = this.getView().byId("idPedidoList");
          console.log(oTable);
        ...
        _cargaInicial: async function () {
          ...
          filterPedidos.push(
            new Filter("Pedido_fechaRegistro", BT, fechaDesde, fechaHasta)
          );
          aPedidoFilter = await that._getODataDinamic(
            that.oModel,
