      ...
      "com.medifarma.cp.pesajeimpresionbultosaldo.controller.Configuracion",
      {
        ...
        onChangeCentro: function (oEvent) {
          ...
          if (centro) {
            ...
            //seteo de planta en local storage
            if (centro == "879") {
              //PLANTA LIMA
              window.localStorage.setItem("PlantaConfig", "1021");
            } else if (centro == "878") {
              //PLANTA ATE
              window.localStorage.setItem("PlantaConfig", "1020");
            }
          } else {
        ...
        _getCentros: function () {
          ...
          that
            ...
            .then((aResp) => {
              ...
              //console.log("Centros: ", new JSONModel(aResp))
              that.getView().setModel(new JSONModel(aResp), "CentroModel");
            });
        },

        _getImpresora: async function (centro, id) {
          var oUrlParameters = {
            $expand: "oPlanta",
          };
          var aFilter = [],
          ...
          var impresoras = await that._getODataDinamic(
            goModel,
            "IMPRESORA",
            oUrlParameters,
            aFilter,
