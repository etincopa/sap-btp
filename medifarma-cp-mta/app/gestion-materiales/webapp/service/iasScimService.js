  ...
  return {
    readUserIasInfo: function (sMail) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var sUrl = "/scimApi/Users?filter=emails eq '" + sMail + "'";
        ...
        oUserInfo
          ...
          .then(() => {
            var oResolve = new JSONModel({});
            var oDataIas = oUserInfo.getData();

            if (oDataIas.Resources[0]) {
              var oResource = oDataIas.Resources[0];
              var oInfo = that._getUserInfo(oResource);
              oResolve = new JSONModel(oInfo);
            }
            resolve(oResolve);
          })
          .catch((oError) => {
    ...
    getUserIAS: function (sEmail) {
      return new Promise(function (resolve, reject) {
        $.ajax({
          type: "GET",
          url: "/scimApi/GroupUsersWithMail?email=" + sEmail,
    ...
    getScimUSerByEmail: function (sEmail) {
      return new Promise(function (resolve, reject) {
        $.ajax({
          type: "GET",
          url: "/scimApi/Users/?filter=emails eq '" + sEmail + "'",
          contentType: "application/json",
          dataType: "json",
          headers: {
            "Content-Type": "application/scim+json",
    ...
    getScimUserByGroup: function (sGroup) {
      return new Promise(function (resolve) {
        ...
        UserInfoModel.loadData("/scimApi/Users/", {
    ...
    getScimDinamic: function (sEntity, sfilter) {
      return new Promise(function (resolve) {
        let UserInfoModel = new JSONModel({});
        UserInfoModel.loadData("/scimApi/" + sEntity + "/", {
          filter: sfilter,
        });
        UserInfoModel.attachRequestCompleted(function () {
          resolve(UserInfoModel.getData());
    ...
    /* Servicio puente de IAS */
    postScimDinamicExt: function (sUrl, oBody) {
      return new Promise(function (resolve, reject) {
        $.ajax({
          url: sUrl,
          method: "POST",
    ...
    getScimDinamicExt: function (sUrl) {
      return new Promise(function (resolve, reject) {
        $.ajax({
          url: sUrl,
          method: "GET",
