...
module.exports = function ({ resources, options }) {
    ...
    return function (req, res, next) {
        ...
        // simulate entryPath of neo-app.json
        var sEntryPath = "";
        ...
        if (service["sap-client"] && req.url.indexOf("sap-client") === -1) {
            var sClient = req.url.indexOf("?") > -1 ? "&" : "?";
            sClient += "sap-client=" + service["sap-client"];
            req.url = req.url + sClient;
            console.log("SAP-CLIENT: " + sClient  + " - " + req.url);
        }
