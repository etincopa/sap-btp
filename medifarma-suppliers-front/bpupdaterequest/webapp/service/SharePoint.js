...
sap.ui.define(
    ["sap/ui/model/json/JSONModel", "sap/ui/core/BusyIndicator", "sap/m/MessageToast"],
        ...
        return {
            ...
            getToken: function (that) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    formData.set(
                        "client_id",
                        "c449c367-8e47-4a9f-aec7-ea16e5d5058c@40980849-8484-4115-bd2e-3cf2e9428b26"
                    );
                    formData.set("client_secret", "4EEWpYuOn9Ghn+LdBP692x3i86xcM9gxi+pYxB47CLs=");
                    formData.set(
                        "resource",
                        "00000003-0000-0ff1-ce00-000000000000/prueba92.sharepoint.com@40980849-8484-4115-bd2e-3cf2e9428b26"
                    );
                    ...
                    var uri =
                        "https://accounts.accesscontrol.windows.net/40980849-8484-4115-bd2e-3cf2e9428b26/tokens/OAuth/2";
...
*/
            ...
            onRefresh: function (that) {
                ...
                userModel
                    .loadData(uri, null, true, "GET", null, null, {
            ...
            getFiles: function (that, aFolders, sAmbient, sProject, sDocumentNumber, sBPRequestID) {
                function getFile(aFolders) {
                    if (aFolders.length > 0) {
                        ...
                        jQuery
                            ...
                            .done(function (response, status, xhr) {
                                if (response.d.results.length > 0) {
                                    that.getView()
                                        .getModel("UploadFile")
                                        .setProperty("/" + oFolder.Id, response.d.results[0].Name);
                                } else {
                                    that.getView()
                                        .getModel("UploadFile")
                                        .setProperty("/" + oFolder.Id, "");
                                }
                                getFile(aFolders);
                                console.log(response);
                            })
                        ...
                        BusyIndicator.hide();
                        that.getView().getModel("UploadFile").refresh();
                    }
                }
            ...
            deleteAllFile: function (that, sFolderName) {
                return new Promise(function (resolve, reject) {
                    ...
                    function getFile(aFolders) {
                        ...
                        var uri =
                            that.uri +
                            `GetFolderByServerRelativeUrl('${sRoot + "/" + that.sFullPath + "/" + sFolderName}')/Files`;
                        //Busca los archivos
                        jQuery
                            .ajax({
                                url: uri,
                                    ...
                                    function deleteFile(aFiles) {
                                        if (aFiles.length > 0) {
                                            ...
                                            var uri =
                                                that.uri +
                                                `GetFolderByServerRelativeUrl('${
                                                    sRoot + "/" + that.sFullPath + "/" + sFolderName
                                                }')/Files('${oFile.Name}')`;
                                            BusyIndicator.show(0);
                                            jQuery
                                                .ajax({
                        ...
                        if (aFiles.length > 0) {
                            ...
                            jQuery
                                ...
                                .done(function (response, status, xhr) {
                                    ...
                                    _this
                                        .deleteAllFile(that, oFile.FolderName)
                                        .then((response) => {
