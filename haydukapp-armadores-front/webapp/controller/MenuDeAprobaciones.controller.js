sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.proyectoScp.controller.MenuDeAprobaciones", {
		...
		_onStandardTilePress2: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("AprobacionDocumentosDeCompras", oBindingContext, fnResolve, "");
		...
		onInit: function() {
			...
			this.oRouter.getTarget("MenuDeAprobaciones").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		}
	});
}, /* bExport= */ true);