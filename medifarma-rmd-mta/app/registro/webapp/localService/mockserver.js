    ...
    var oMockServerInterface = {
        ...
        init: function (oOptionsParameter) {
            ...
            return new Promise(function (fnResolve, fnReject) {
                ...
                oManifestModel.attachRequestCompleted(function () {
                    var oUriParameters = new UriParameters(window.location.href),
                        ...
                        oMainDataSource = oManifestModel.getProperty("/sap.app/dataSources/mainModelv2"),
			...
			var oMockServer = new MockServer({
				rootUri: "http://localhost:8080/srv_api/v2/browse/"
			});
			...
			// simulate
			var sPath = sap.ui.require.toUrl("mif/rmd/registro/localService");
			//oMockServer.simulate(sPath + "/metadata1.xml", sPath + "/mockdata");
            oMockServer.simulate(sPath + "/metadata1.xml");
