sap.ui.define([
    ...
    return {
        ...
        onValidateEtapaEtiqueta: function (sEtapa) {
            let sValue = "";
            if (sEtapa === "FABR") {
                sValue = "FABRICACIÓN: "
            } else if (sEtapa === "ENVS") {
                ...
                columns: [
                {
                    ...
                    body: [
                        ...
                        [
                            {
                                colSpan:2,
                                text: oThat.onValidateEtapaEtiqueta(lineaRMD.etapa) + lineaSeleccionadaMuestreo.cantRechazo + " " + (lineaRMD.Amein ? lineaRMD.Amein : ''),
                                bold: true,
                                fontSize: 2
                            },
                            '',
                            {
                                colSpan:2,
                                text: oThat.onValidateEtapaEtiqueta(lineaRMD.etapa) + lineaRMD.vfmng + " " + (lineaRMD.Amein ? lineaRMD.Amein : ''),
                                bold: true,
                                fontSize: 2
                            }, 
                            ''
