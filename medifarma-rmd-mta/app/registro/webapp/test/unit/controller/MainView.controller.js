...
sap.ui.define([
	...
	"mif/rmd/registro/controller/MainView.controller",
	...
	/* 	QUnit.test("Test setEstructurasRmdInsumoTest MainView controller", function (assert) {
			var oMainViewController = new MainViewController();
			oMainViewController.onInit();
			var fnDone = assert.async();
			oMainViewController.setEstructurasRmdInsumoTest({mdId:"1"})
				.then(function () {
					assert.ok(true, "Prueba satisfactoria");
					fnDone();
				})
	...
	/* QUnit.test("Test setUpdateRmd MainView controller", function (assert) {
		var oMainViewController = new MainViewController();
		oMainViewController.onInit();
		var fnDone = assert.async();
		oMainViewController.setUpdateRmd({rmdId:"1"});
		assert.ok(true, "Prueba satisfactoria");
	});  */

	/* QUnit.test("Test onGetRmd MainView controller", function (assert) {
		var oMainViewController = new MainViewController();
		oMainViewController.onInit();
		var fnDone = assert.async();
		oMainViewController.onGetRmd("1")
			.then(function () {
				assert.ok(true, "Prueba satisfactoria");
				fnDone();
			})
 ...
 */
	...
	/* 	QUnit.test("Test setEstructurasRmdInsumoTest MainView controller", function (assert) {
			var oMainViewController = new MainViewController();
			oMainViewController.onInit();
			oMainViewController.mainModelv2 = this.mainModelv2;
			var fnDone = assert.async();
			oMainViewController.setEstructurasRmdInsumoTest({mdId:"1"})
				.then(function () {
					assert.ok(true, "success handler called");
