		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Configuracion RMD",
									"targetURL": "#ConfiguracionRMD-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ConfiguracionRMD-display": {
								"semanticObject": "ConfiguracionRMD",
								"action": "display",
								"description": "Configuracion RMD",
								"title": "Configuracion RMD",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mif.rmd.configuracion",
									"url": sap.ui.require.toUrl("mif/rmd/configuracion")
								}
							}
						}
					}
