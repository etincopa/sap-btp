	...
	return {
		...
		getTaskContextByActivityId: function (instanceID, activityId) {
			return new Promise(function (resolve, reject) {
				this.getTaskByActivityId(instanceID, activityId).then(function (activityContext) {
					...
					$.ajax({
						type: "GET",
						url: oManifestObject.resolveUri("bpmworkflowruntime/v1/task-instances/" + taskInstanceId + "/context"),
						contentType: "application/json",
						dataType: "json",
		...
		getTaskByActivityId: function (instanceID, activityId) {
			return new Promise(function (resolve, reject) {
				$.ajax({
					type: "GET",
					url: oManifestObject.resolveUri("bpmworkflowruntime/v1/task-instances?workflowInstanceId=" + instanceID),
					contentType: "application/json",
					dataType: "json",
					success: function (result) {
						var activityContext = {};
