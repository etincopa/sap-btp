      ...
      onAgregarOrdenPress: function () {
        if (this.oOrdenSinAsignar) {
          ...
          aGrupoOrdenDetalle = aGrupoOrdenDetalle.sort((b, a) =>
            a.numero > b.numero && a.pedidoNumero > b.pedidoNumero
              ? -1
              : b.numero > a.numero && b.pedidoNumero > a.pedidoNumero
              ? 1
              : 0 && a.numFraccion > b.numFraccion
          );
          ...
          const iSplicePos = aOrdenesSinAsignar.findIndex(
            (e) =>
              e.ordenId == this.oOrdenSinAsignar.ordenId &&
              e.codigoInsumo == this.oOrdenSinAsignar.codigoInsumo &&
              e.lote == this.oOrdenSinAsignar.lote &&
              e.numFraccion == this.oOrdenSinAsignar.numFraccion
          );
      ...
      onQuitarOrdenPress: function () {
        if (this.oDetalle) {
          ...
          let oGrupoOrdenDetalleAux = aGrupoOrdenDetalleAux.find(
            (e) =>
              e.ordenId == this.oDetalle.ordenId &&
              e.lote == this.oDetalle.lote &&
              e.codigoInsumo == this.oDetalle.codigoInsumo &&
              e.numFraccion == this.oDetalle.numFraccion
          );

          let oOrden = {};
          oOrden = JSON.parse(JSON.stringify(this.oDetalle));
          oOrden.codigo = aOrdenesSinAsignar.length + 1;
          oOrden.pedidoNumero = oGrupoOrdenDetalleAux.numPedido
            ? oGrupoOrdenDetalleAux.numPedido
            : oGrupoOrdenDetalleAux.pedidoNumero;
