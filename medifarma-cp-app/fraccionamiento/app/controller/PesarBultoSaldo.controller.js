      ...
      "mif.cp.fraccionamiento.controller.PesarBultoSaldo",
      {
        ...
        onBalanzaChange: async function (oEvent) {
          ...
          if (oBalanza.balanzaId == "0") {
            ...
            var iPendienteUM = this._getProperty("/unidadMostrar");

            if (
              iPendienteUM.toUpperCase() !=
              oBalanza.oUnidad_codigo.toUpperCase()
            ) {
              var iPendiente = this._getProperty("/Pesaje_PesoBalanza");
              ...
              this._setProperty("/Pesaje_PesoBalanza", formatter.peso(newPeso));
            ...
            if (!oBultoScan.IdBulto) {
              ...
              if (!oBultoHu || oBultoHu.length == 0 || oBultoHu.error) {
                ...
                if (["E"].includes(oBultoHu.Type)) {
                  ...
                  oBulto.SaldoAdicional =
                    !oBultoExiste || oBultoExiste.error != null;
        ...
        onTaraManualPress: function () {
          ...
          if (oOpciones.TaraManual) {
            ...
            if (umInsumo) {
              var umInsumo = this._getProperty("/unidadMostrar");
            ...
            this._setProperty(
              "/EnterValueUM",
              bBalanzaPiso ? oBalanza.oUnidad_contenido : "G"
            );
        ...
        onEstablecerTaraManual: async function () {
          ...
          var umInsumo = this._getProperty("/unidadMostrar");
          var oBalanza = this._getProperty("/Pesaje_Balanza");
          var umBalanzaR = oBalanza.oUnidad_contenido;
          var cantPesar = iTara;
          var cantBalanza = iTara;
          var oPeso = this._factConversion(
            cantPesar,
        ...
        onAceptarTeclado: async function (oEvent) {
          if (
            selectMenu == "CREA_NUEVO" ||
            selectMenu == "PESA" ||
            selectMenu == "CREA_ADICIONAL"
          ) {
        ...
        onAceptarManual: async function (oEvent) {
          ...
          if (oAction === "SI") {
            ...
            var bValidaBulto =
              selectMenu == "CREA_NUEVO" && !oBultoQrAux.Codigoinsumo;
        ...
        onEstablecerTara: async function (sCommand, manual) {
          ...
          if ((!bPesoEstable || manual) && self.bEstableceTara) {
            ...
            if (result.iCode == 1) {
              ...
              var umInsumo = self._getProperty("/unidadMostrar");
              var cantPesar = iTara;
              var cantBalanza = iTara;

              var umBalanzaR = that._getProperty("/Pesaje_umBalanzaR");
              umBalanzaR = umBalanzaR == undefined || umBalanzaR == null ? umInsumo  :umBalanzaR;
        ...
        onGuardarPesaje: async function (oEvent) {
          ...
          try {
            ...
            var iBalanzaPeso = this._getProperty("/Pesaje_PesoBalanza");
            ...
            if (+iTaraBalanza == 0 && fPesajeTotal > 0) {
              this.onConnectBalanza("SI");
              MessageBox.msgError("El valor de la tara debe ser mayor a CERO");
              BusyIndicator.hide();
              return;
            ...
            var sBalanzaPesoUM = this._getProperty("/unidadMostrar"); //Peso Balanza Unidad Medida
            var sUnidadMOrigen = oBultoQr.Vemeh; //Unidad real del Insumo
            /**
            ...
            if (oBultoQr) {
              ...
              iBalanzaPesoConv = formatter.peso(iBalanzaPesoConv);
              iBalanzaPeso = formatter.peso(iBalanzaPeso);
                ...
                var aActBultSaldo = await grupoOrden.ActBultSalMisHuHeadSet([
                  {
                    ...
                    CantPesada: iBalanzaPesoConv, //Cantidad Neta Balanza
                    Umed: oBultoQr.Vemeh,

                    PesoNeto: iBalanzaPeso, //Cantidad Neta Balanza
                    PesoTara: iTaraBalanza, //Peso Tara
                    PesoBruto: formatter.peso(+iBalanzaPeso + +iTaraBalanza),
                  },
                ]);
              } else if (selectMenu == "CREA_ADICIONAL") {
                /**
                ...
                var aActBultSaldo = await grupoOrden.ActBultSalNueHuHeadSet([
                  {
                    ...
                    PesoNetoKilos: iBalanzaPeso, //Cantidad Neta Balanza
                    PesoTaraKilos: iTaraBalanza, //Peso Tara
                    PesoBrutoKilos: formatter.peso(
                      +iBalanzaPeso + +iTaraBalanza
                    ),
                  },
                ]);
              } else if (selectMenu == "CREA_NUEVO") {
              ...
              if (aActBultSaldo && aActBultSaldo.statusCode == "200") {
                ...
                if (aMessajeError.length) {
                  ...
                  oBultoAtendido.PesoNeto = iBalanzaPeso;
        ...
        onRefrescarDatos: async function () {
          ...
          try {
            ...
            var pendiente = this._getProperty("/Pesaje_PesoBalanza");
          ...
          try {
            ...
            var oResp = await grupoOrden.fnSendPrintBulto({
              ...
              bSaldo:
                ...
                "|" +
                (bSaldoAdicional && this.bBultoSaldoGuardado
                  ? oAtendido.Exidv
                  : oBultoQr.Hu) +
                "|" +
                this._getProperty("/unidadMostrar"),
            });
            if (oResp.iCode == "1") {
              BusyIndicator.hide();
              ...
              if (sIdBalanzaSelect == "0") {
                ...
                if (result.iCode == 1) {
                  ...
                  this.sBalanzaPesoEstable =
                    (sMensaje[1] ? sMensaje[1] : "").trim().toUpperCase() ==
                    "S";
        ...
        _initProperty: function () {
          ...
          this._setProperty("/unidadMostrar", "");
