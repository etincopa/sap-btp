  ...
  function (
    ...
    return Controller.extend("mif.cp.fraccionamiento.controller.ReembalajeHU", {
      ...
      _cargarItems: async function (salaPesajeId) {
        ...
        var aFraccionamientos =
          await grupoOrden.obtenerFraccionamientosReembalaje(
            salaPesajeId,
            aUnidades
          );

        this.oLocalModel.setProperty("/atender", true);
      ...
      onItemRowSelected: async function (oEvent) {
        try {
          ...
          if (oRowSelect) {
            ...
            var oFraccionamiento = await grupoOrden.obtenerFraccionamiento(
      ...
      onAtenderPress: async function () {
        ...
        if (oOpciones.ReembalajeHU) {
          if (this.oFraccionamiento !== null) {
            this.oLocalModel.setProperty("/Detalle_Fraccionamiento", null);
