    ...
    return Controller.extend(
      "mif.cp.fraccionamiento.controller.PesajeReembalajeHU",
      {
        ...
        _cargarDatos: async function () {
          ...
          try {
            ...
            if (aMaterialEmbalaje.length > 0) {
              ...
              var oMaterialBolsa = aMaterialEmbalaje.find(
                (d) => d.codigo == "MEBOPL"
              );
            ...
            const pendiente =
              ...
              (oFraccionamiento.atendido == null
                ? 0
                : oFraccionamiento.atendido);
        ...
        onFinalizarPress: async function () {
          ...
          if (oAction === "SI") {
            try {
              ...
              await grupoOrden.acSetEtiquetaErp(oUrlParam);
          ...
          this.timerTarar = setInterval(async function () {
            if (!bPesoEstable && self.bEstableceTara) {
              ...
              if (result.iCode == 1) {
                ...
                /*
                var iFacBal = self._jsConvertUnits(
                  "MASA",
                  umBalanza,
                  umBalanza,
                  cantPesar
                );
                var iFacBal = formatter.peso(iFacBal);
                */
        ...
        onMostrarTeclado: function (oEvent) {
          ...
          this.openDialog("QrManual", {
            source: "PesajeReembalajeHU_" + action,
          });
        },
