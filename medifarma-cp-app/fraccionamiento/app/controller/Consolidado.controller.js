  ...
  function (
    ...
    return Controller.extend("mif.cp.fraccionamiento.controller.Consolidado", {
      ...
      onInit: async function () {
        ...
        this.idGrupoOrden = null;
        this.idSalaPesaje = null;
      },
      ...
      onEstadoChange: async function (oEvent) {
        try {
          ...
          var iSalaPesajeId = this.oLocalModel.getProperty("/Consolidado_salaId");

          if (!oGrupoOrden || !iSalaPesajeId) {
      ...
      cargarDatos: async function (grupoOrdenId, salaPesajeId) {
        ...
        this.oLocalModel.setProperty("/Consolidado_salaId", salaPesajeId);

        const aSalaPesaje = await grupoOrden.obtenerSalaPesaje(
          salaPesajeId,
          ""
        );
        this.oLocalModel.setProperty("/SalaPesaje", aSalaPesaje[0].sala);
      ...
      onRouteMatched: async function (oEvent) {
        ...
        this.idGrupoOrden = oArgs.grupoOrdenId;
        this.idSalaPesaje = oArgs.salaPesajeId;
      ...
      onAfterRendering: async function() {
        try {
          var estadosCons = this.oLocalModel.getProperty("/EstadosConsolidado");
          var salaPesaje = this.oLocalModel.getProperty("/SalaPesaje");
          var consolidado = this.oLocalModel.getProperty("/Consolidado");
          if(!estadosCons || !salaPesaje || !consolidado){
            var grupoOrdenId = this.oLocalModel.getProperty("/grupoOrdenId");
            var salaPesajeId = this.oLocalModel.getProperty("/salaPesajeId");
            await this.cargarDatos(grupoOrdenId, salaPesajeId);
          } 
