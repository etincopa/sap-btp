  ...
  function (
    ...
    return Controller.extend("mif.cp.fraccionamiento.controller.Atencion", {
      ...
      _cargarGrupoOrdenes: async function (salaPesajeId) {
        ...
        this.oLocalModel.setProperty("/GrupoOrdenMax", sCodigo);
          ...
          if (oGrupoOrdenDetalle) {
            ...
            if (oAtendido) {
              ...
              if (oResp.iCode == "1") {
                ...
                var iSalaPesajeId =
                  this.oLocalModel.getProperty("/SalaPesajeId");

                let grupoOrdenDetalle =
                  await grupoOrden.obtenerGrupoOrdenDetalle(
      ...
      onAfterRendering: async function() {
        try {
          ...
          BusyIndicator.show(0);
          var grupoOrdenes = this.oLocalModel.getProperty("/GrupoOrdenes");
          var salaPesajes = this.oLocalModel.getProperty("/SalaPesajes");
          if(!grupoOrdenes || !salaPesajes){
            this.byId("tblGrupoOrden").clearSelection();
            let salaPesajes = await grupoOrden.obtenerSalaPesaje(
              null,
              this.oConfiguracion.plantaId
